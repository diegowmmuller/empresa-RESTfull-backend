...
export class FuncionarioController {
	...
	async buscarFuncionarioPorId(req: Request, res: Response) {
		const { id } = req.params;
	...
	async atualizarFuncionario(req: Request, res: Response) {
		const { id } = req.params;
		const dados = req.body;
	...
	async deletarFuncionario(req: Request, res: Response) {
		const { id } = req.params;
